...
class _MyRegisterWidget extends State<RegisterWidget>
  ...
  void _loadSettings() async {
    ...
    setState(() {
      ...
      _displayNameController.text =
          _preferences.getString('display_name') ?? 'SIP UA';
  ...
  void _handleSave(BuildContext context) {
    ...
    } else if (_authorizationUserController.text == '') {
      _alert(context, "Auth User");
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: const InputDecoration(
                              hintText: 'wss://tryit.jssip.net:8089/ws',
